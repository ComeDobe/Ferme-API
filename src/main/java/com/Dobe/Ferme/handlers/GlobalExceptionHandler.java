package com.Dobe.Ferme.handlers;

import com.Dobe.Ferme.exceptions.ObjectValidationException;
import com.Dobe.Ferme.exceptions.OperationNonPermittedException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionRepresentation> handleException(BadCredentialsException exception){
        ...
        ExceptionRepresentation representation=ExceptionRepresentation.builder()
                .errorMessage("votre email et/ou votre mot de passe est incorrecte")
                .build();
        return ResponseEntity
                .status(HttpStatus.FORBIDDEN)
                .body(representation);
